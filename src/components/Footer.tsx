    ...
    <footer className="bg-slate-900 border-t border-slate-800 text-slate-300 w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-slate-400 text-sm max-w-xs">
              Your ultimate guide and preparation resource for the Overseas Pharmacist Readiness Assessment in Australia.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="#about" className="hover:text-emerald-400 transition-colors">About OPRA</Link></li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-sm text-center text-slate-500 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-2 md:mt-0">Not affiliated with the Australian Pharmacy Council.</p>
        </div>
      </div>
    </footer>
  );
